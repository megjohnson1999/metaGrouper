...
try:
    ...
    logging.warning("Phase 1 optimizations not available")
...
def parse_arguments():
    ...
    # Phase 1 arguments (streaming and sparse analysis)
    parser.add_argument(
        "--use-sketching",
        action="store_true",
    ...
    parser.add_argument(
        ...
        type=int,
        default=1000,
        help="Size of k-mer sketches (default: 1000)"
    )
    parser.add_argument(
        "--sampling-method",
        choices=["reservoir", "frequency", "adaptive"],
        default="frequency",
        help="Sketching sampling method (default: frequency)"
    )
    parser.add_argument(
        "--similarity-threshold",
        type=float,
        default=0.1,
        help="Minimum similarity to store in sparse matrix (default: 0.1)"
    )
